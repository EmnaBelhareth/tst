...
(() => {
              ...
              t.preventDefault(),
                this.dispatchEvent(
                  new CustomEvent("propertiesChanged", {
                    detail: { properties: { tableTitle: this.tableTitle } },
                  })
                );
            },
          },
  ...
  function s() {
    ...
    return (
      ...
      (g.displayName = f(x, u, "GeneratorFunction")),
    ...
    function e() {
      ...
      return (
        ...
        (t = (function (t, e) {
          ...
          n,
          m() ? Reflect.construct(r, o || [], g(n).constructor) : r.apply(n, o)
        )))._shadowRoot = t.attachShadow({ mode: "open" })),
        t._shadowRoot.appendChild(x.content.cloneNode(!0)),
        (t._tableTitle = t._shadowRoot.querySelector("#tableTitle")),
        (t._myTable = t._shadowRoot.querySelector("#myTable")),
        (t._props = {}),
        t
      );
    }
                  ...
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          (n = e),
                            (r = this._shadowRoot.querySelector("#myTable")),
                            (o = r.querySelector("thead")),
